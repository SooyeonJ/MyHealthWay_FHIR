...
node {
    ...
    // ##수정포인트: 부그룹, 프로젝트 이름
    def subGroup = 'fhir'
    def project = 'fhir-jpaserver'
    def defaultBranch = 'prod'
    def branchName
    def gitCommitId
    // Nexus 릴리즈 저장소
    def repository = 'fhir-release'
    // Nexus 릴리즈 저장소 url
    def nexusDeploymentRepository = 'http://mhw-cicd-nexus3:8081/repository/mhw-fhir-release-repository/'
    // Nexus 릴리즈 저장소 접근 key
    def nexusCredentialsId = 'nexus-fhir-release-key'
    // Nexus 릴리즈 저장소의 서버 ID
    def nexusServerId = 'mhw-Nexus-Fhir-Release'
