...
node {
    ...
    def defaultBranch = 'stg'
    def branchName
    def gitCommitId
    // Nexus 릴리즈 저장소
    def repository = 'fhir-staging'
    // Nexus 릴리즈 저장소 url
    def nexusDeploymentRepository = 'http://mhw-cicd-nexus3:8081/repository/mhw-fhir-staging-repository/'
    // Nexus 릴리즈 저장소 접근 key
    def nexusCredentialsId = 'nexus-fhir-staging-key'
    // Nexus 릴리즈 저장소의 서버 ID
    def nexusServerId = 'mhw-Nexus-Fhir-Staging'
