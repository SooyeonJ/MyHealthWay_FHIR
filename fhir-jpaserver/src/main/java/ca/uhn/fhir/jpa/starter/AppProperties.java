...
public class AppProperties {
	...
	private Boolean enable_repository_validating_interceptor = true;
	...
	// CryptoConfig start
	private String rsa_key_request_url = null;

	public String getRsa_key_request_url() {
		return rsa_key_request_url;
	}

	public void setRsa_key_request_url(String rsa_key_request_url) {
		this.rsa_key_request_url = rsa_key_request_url;
	}

	// OAuthConfig start
	private String oauth_server_url = null;
	...
	private String oauth_server_clientid = null;
	public String getOauth_server_clientid() {
		return oauth_server_clientid;
	}

	public void setOauth_server_clientid(String oauth_server_clientid) {
		this.oauth_server_clientid = oauth_server_clientid;
	}

	private String oauth_server_secretkey = null;
	public String getOauth_server_secretkey() {
		return oauth_server_secretkey;
	}

	public void setOauth_server_secretkey(String oauth_server_secretkey) {
		this.oauth_server_secretkey = oauth_server_secretkey;
	}
	// OAuthConfig end
