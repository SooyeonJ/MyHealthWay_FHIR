...
/**
 * LZ4를 이용한 초경량/초고속 압축 유틸리티
 * <p>
 * &#x2022; JSON, XML등 텍스트 데이터를 가볍게 압축하는데 유용하다.<br>
 * &#x2022; 바이너리 등 엔트로피가 높은 데이터에는 사용을 권장하지 않는다.<br>
 * &nbsp;&nbsp;&#x203b; 압축 결과가 더 커질 수 있다.<br>
 * &#x2022; dependency에 <strong>lz4-java</strong>를 추가해야 한다.
 * 
 * <pre>
 * &#x2022; 예제코드
 * {@code
 *   // 압축 시
 *   MymdLz4Util lz4Util = new MymdLz4Util();
 *   byte[] lz4Compressed = lz4Util.compress(data);
 * 
 *   // 해제 시
 *   MymdLz4Util lz4Util = new MymdLz4Util();
 *   byte[] lz4Decompressed = lz4Util.decompress(lz4Compressed);
 * }
 * </pre>
 * 
 * @author dhsong
 * @since 2022. 11. 24
 *
 * @see <a href="https://lz4.github.io/lz4">LZ4</a>
 * @see <a href="https://github.com/lz4/lz4-java">LZ4 compression for Java</a>
 */
public class MymdLz4Util {
